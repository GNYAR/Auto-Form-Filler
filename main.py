...
def Login():
    print("\n========自動登入========\n")
    print("開啟網頁...",end="")
    driver.get("https://sso.nutc.edu.tw")
    print("完成")
    stu, pw = "s1110634039", "11Ray2019"
    #填學號
...
def Program():
    ...
    print("開啟作業系統...",end="")
    #學生管理系統
    driver.find_element_by_link_text("智慧大師").click()
    #轉移控制網頁
    driver.switch_to_window(driver.window_handles[1])
    #我的作業
    sleep(3)
    driver.switch_to_frame(driver.find_element_by_name("s_main"))
    driver.find_element_by_xpath('/html/body/div/div/div[2]/div[3]/div/table/tbody/tr[4]/td[5]/div/a').click()
    print("完成")
    while(1):
        s = input("\n離開請按[0]：")
        if(s == "0"):
